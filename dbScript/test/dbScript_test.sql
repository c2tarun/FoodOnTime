DROP DATABASE IF EXISTS foodontime_test;
GRANT USAGE ON *.* TO 'dbtest_user'@'localhost';
DROP USER 'dbtest_user'@'localhost';

CREATE DATABASE foodontime_test;

USE foodontime_test;

CREATE USER dbtest_user@localhost IDENTIFIED BY 'foodontime';

GRANT ALL
ON foodontime_test.*
TO dbtest_user@localhost;
